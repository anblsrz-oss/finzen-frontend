  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Sincroniza tus movimientos directo del banco, sin subir archivos."
      />
      ...
      <Card className="grid gap-3">
        ...
        <p className="text-sm text-slate-600">
          Estamos preparando la conexión directa con bancos y SOFIPOs mediante un
          agregador de Open Finance. Mientras tanto, puedes traer tus movimientos
          gratis por dos vías:
        </p>
        <ul className="list-inside list-disc text-sm text-slate-600">
          <li>
            <strong>Importar</strong> tu estado de cuenta (CSV) — todas las
            plataformas.
          </li>
          <li>
            <strong>Sincronizar correo</strong> de alertas del banco — casi en
            tiempo real.
          </li>
          <li>
            <strong>Leer SMS</strong> de alerta — solo en la app de Android.
          </li>
        </ul>
        {!isPremium && (
